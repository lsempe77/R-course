...
- Effect: `r round(out_did$coefficients[4],0)` AED (95% CI: [`r round(out_did$coefficients[4] + 1.96*out_did$std.error[4],0)`, `r round(out_did$coefficients[4] - 1.96*out_did$std.error[4],0)`])
