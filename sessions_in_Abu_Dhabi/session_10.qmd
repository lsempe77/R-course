...
- **Methods**: Exact matching, propensity score matching, nearest neighbor, etc.
:::
...
all_results <- data.frame(
  Method = c("Randomized Assignment", "Instrumental Variables", 
             ...
             "Matching (Full Set)"),
  Estimate = c(-10.14, -9.74, -9.03, -8.16, -10.00),
  SE = c(0.35, 0.96, 0.44, 0.33, 0.37),
  CI_Lower = c(-10.83, -11.63, -9.90, -8.81, -10.73),
  CI_Upper = c(-9.45, -7.86, -8.16, -7.52, -9.27)
)
...
ggplot(all_results, aes(y = reorder(Method, Estimate), x = Estimate)) +
  ...
  labs(title = "Impact of HISP on Health Expenditures",
       ...
       y = "") +
  theme_minimal() +
  annotate("text", x = -10, y = 5.5, label = "Threshold", color = "red", hjust = 1.2)
```
