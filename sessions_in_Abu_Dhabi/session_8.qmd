...
# modelsummary(coef_omit = c(-1), coef_map = c("enrolled" = "RDD Effect"),
#              list("Quadratic RDD"= out_rdd_quadratic,"Cubic RDD" = out_rdd_cubic), stars = TRUE,
...
- Effect: `r round(out_rdd$coefficients[3],0)` AED (95% CI: [`r round(out_rdd$coefficients[3] + 1.96*out_rdd$std.error[3],0)`, `r round(out_rdd$coefficients[3] - 1.96*out_rdd$std.error[3],0)`])
...
4. Multiple specifications yield consistent estimates of approximately 905 AED reduction
