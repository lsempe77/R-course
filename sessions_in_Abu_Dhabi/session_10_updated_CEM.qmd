...
ggplot(cem_demo, aes(x = efficiency, y = distance, color = enrolled, shape = enrolled)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("case_study_outputs/cem_before.png", width=8, height=5)
```
...
ggplot(cem_matched, aes(x = efficiency, y = distance, color = enrolled, shape = enrolled)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("case_study_outputs/cem_after.png", width=8, height=5)
```
...
ggplot(cem_viz, aes(x = efficiency_index_0, y = recycling_center_distance_0,
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("case_study_outputs/cem_before_real_data.png", width=8, height=5)
```
...
ggplot(cem_matched_viz, aes(x = efficiency_index_0, y = recycling_center_distance_0,
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("case_study_outputs/cem_after_real_data.png", width=8, height=5)
```
...
<!-- - Most quasi-experimental methods: Effect slightly below the threshold -->
<!-- - Given uncertainty in estimates and consistency in direction, GreenWaste shows promising results -->

<!-- **RECOMMENDATION**: The preponderance of evidence suggests GreenWaste reduces waste expenditures by approximately 1,000 AED, which meets the threshold criterion. Given the consistency across methods and the gold-standard randomized result, GreenWaste should be scaled up nationally. -->
